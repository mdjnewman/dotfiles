...
# Add tab completion for many Bash commands, based on brew prefix
# if which brew &> /dev/null && [ -f "$(brew --prefix)/share/bash-completion/bash_completion" ]; then # note this is slow
